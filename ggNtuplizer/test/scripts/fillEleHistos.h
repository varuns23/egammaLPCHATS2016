...
// Wed Jun  8 00:57:05 2016 by ROOT version 6.02/13
// from TTree EventTree/Event data
// found on file: ../dy_ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef fillEleHistos_h
#define fillEleHistos_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fillEleHistos(TTree *tree=0);
   virtual ~fillEleHistos();
...
#ifdef fillEleHistos_cxx
fillEleHistos::fillEleHistos(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../dy_ggtree_mc.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../tt_ggtree_mc.root");
      if (!f || !f->IsOpen()) {
         //f = new TFile("../dy_ggtree_mc.root");
         f = new TFile("../tt_ggtree_mc.root");
      }
      //TDirectory * dir = (TDirectory*)f->Get("../dy_ggtree_mc.root:/ggNtuplizer");
      TDirectory * dir = (TDirectory*)f->Get("../tt_ggtree_mc.root:/ggNtuplizer");
...
fillEleHistos::~fillEleHistos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fillEleHistos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fillEleHistos::LoadTree(Long64_t entry)
{
...
void fillEleHistos::Init(TTree *tree)
{
...
void fillEleHistos::Show(Long64_t entry)
{
...
Int_t fillEleHistos::Cut(Long64_t entry)
{
