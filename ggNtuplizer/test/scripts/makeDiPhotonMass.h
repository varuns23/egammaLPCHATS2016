...
// Wed Jun  8 02:10:04 2016 by ROOT version 6.02/13
// from TTree EventTree/Event data
// found on file: ../hgg_ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef makeDiPhotonMass_h
#define makeDiPhotonMass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   makeDiPhotonMass(TTree *tree=0);
   virtual ~makeDiPhotonMass();
   ...
   virtual int      MCTruthMatch(int jpho);
   virtual bool     phoCut(int i);
};

#endif

#ifdef makeDiPhotonMass_cxx
makeDiPhotonMass::makeDiPhotonMass(TTree *tree) : fChain(0) 
{
...
makeDiPhotonMass::~makeDiPhotonMass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t makeDiPhotonMass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeDiPhotonMass::LoadTree(Long64_t entry)
{
...
void makeDiPhotonMass::Init(TTree *tree)
{
...
Bool_t makeDiPhotonMass::Notify()
{
...
void makeDiPhotonMass::Show(Long64_t entry)
{
...
Int_t makeDiPhotonMass::Cut(Long64_t entry)
{
...
#endif // #ifdef makeDiPhotonMass_cxx
