...
// Wed Jun  8 02:10:47 2016 by ROOT version 6.02/13
// from TTree EventTree/Event data
// found on file: ../dy_ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef makeDiElectronMass_h
#define makeDiElectronMass_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   makeDiElectronMass(TTree *tree=0);
   virtual ~makeDiElectronMass();
...
#ifdef makeDiElectronMass_cxx
makeDiElectronMass::makeDiElectronMass(TTree *tree) : fChain(0) 
{
...
makeDiElectronMass::~makeDiElectronMass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t makeDiElectronMass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeDiElectronMass::LoadTree(Long64_t entry)
{
...
void makeDiElectronMass::Init(TTree *tree)
{
...
Bool_t makeDiElectronMass::Notify()
{
...
void makeDiElectronMass::Show(Long64_t entry)
{
...
Int_t makeDiElectronMass::Cut(Long64_t entry)
{
...
#endif // #ifdef makeDiElectronMass_cxx
