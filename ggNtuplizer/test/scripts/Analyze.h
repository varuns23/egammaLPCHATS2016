...
public :
   ...
   bool TightElectron(int& );
   float effArea(float );
   bool MediumPhoton(int& );
   float EaNeutralHadrons(float );
   float EaPhotons(float );
   float dRCalc(float ,float ,float ,float );
   bool Collision(int );
...
Analyze::Analyze()
{
   ...
   chain->Add("/uscms_data/d3/varun/13TeV/2016-ElectronPhotonHATS/FakeRate/rootFiles/DoubleEG_data.root");
   //chain->Add("/uscms_data/d3/varun/13TeV/2016-ElectronPhotonHATS/FakeRate/rootFiles/ggtree_data_1.root");
