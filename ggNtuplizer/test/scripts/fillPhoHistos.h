...
// Wed Jun  8 01:32:46 2016 by ROOT version 6.02/13
// from TTree EventTree/Event data
// found on file: ../hgg_ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef fillPhoHistos_h
#define fillPhoHistos_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   fillPhoHistos(TTree *tree=0);
   virtual ~fillPhoHistos();
...
#ifdef fillPhoHistos_cxx
fillPhoHistos::fillPhoHistos(TTree *tree) : fChain(0) 
{
...
fillPhoHistos::~fillPhoHistos()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t fillPhoHistos::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t fillPhoHistos::LoadTree(Long64_t entry)
{
...
void fillPhoHistos::Init(TTree *tree)
{
...
void fillPhoHistos::Show(Long64_t entry)
{
...
Int_t fillPhoHistos::Cut(Long64_t entry)
{
