...
// Wed Jun  8 04:11:34 2016 by ROOT version 6.02/13
// from TTree EventTree/Event data
// found on file: ../hgg_ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef getPhotonIsoEfficency_h
#define getPhotonIsoEfficency_h
...
getPhotonIsoEfficency::~getPhotonIsoEfficency()
{
   if (!fChain) return;
...
void getPhotonIsoEfficency::Init(TTree *tree)
{
...
Bool_t getPhotonIsoEfficency::Notify()
{
